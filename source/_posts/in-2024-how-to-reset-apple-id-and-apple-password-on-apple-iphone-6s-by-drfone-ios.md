...
date: 2024-04-30T15:32:33.335Z
updated: 2024-05-01T15:32:33.335Z
tags: 
  - unlock
...
- Removes the Apple iPhone 6s lock screen without relying on iTunes.
...
**Step 1: Connect your Apple iPhone 6s to the system**
...
Now, you will be given an option to either unlock an Android or an iOS device. Simply select the option to unlock Apple ID of the Apple iPhone 6s device.
...
To proceed, the application would require erasing the Apple iPhone 6s device. As the following prompt will appear, you can enter the on-screen displayed code to confirm your choice. Afterward, click on the "Unlock Now" button.

![attention](https://images.wondershare.com/drfone/guide/remove-apple-id-6.png)

**Step 4: Reset Apple ID**

As the Apple iPhone 6s device restarted, the application would follow the needed process to reset its Apple ID. You can wait for a few minutes for the process to be completed.
...
2. Apple should send a verification code to the Apple iPhone 6s device you selected. Enter this code as requested on the website and click "Next".
...
1. On the Apple iPhone 6s device, open Settings > iCloud.
